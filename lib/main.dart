  ...
  Future<void> _initConfig() async {
    await _remoteConfig.setConfigSettings(RemoteConfigSettings(
      fetchTimeout: const Duration(
          minutes: 1), // a fetch will wait up to 10 seconds before timing out
      ...
      body: Center(
        child: Card(
          ...
          child: Padding(
            ...
            child: Text(
              _remoteConfig.getString('welcome_string').isNotEmpty
                  ? _remoteConfig.getString('welcome_string')
                  : _defaultBannerText,
